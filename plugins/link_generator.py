...
@OTAKULUX.on_message(filters.private & admin & filters.command('batch'))
async def batch(client: Client, message: Message):
    ...
    link = f"https://t.me/OTAKULUX{client.username}?start={base64_string}"
    reply_markup = InlineKeyboardMarkup([[InlineKeyboardButton("🔁 Share URL", url=f'https://telegram.me/share/url?url={link}')]])
    await second_message.reply_text(f"<b>Here is your link</b>\n\n{link}", quote=True, reply_markup=reply_markup)


@OTAKULUX.on_message(filters.private & admin & filters.command('genlink'))
...
@OTAKULUX.on_message(filters.private & admin & filters.command("custom_batch"))
