...
#--------------------------------------------
#Bot token @OTAKULUX
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "8672264237:AAFMBPpcnxaPqNByGjaXX8VZGF8LV5xlelg")
...
SHORTNER_ENABLED = os.environ.get("SHORTNER_ENABLED", "True").lower() == "true"
