...
WRAPPED_URL_DOMAIN = os.environ.get("WRAPPED_URL_DOMAIN", "darkguruji.com")
WRAPPED_URL_PATH = os.environ.get("WRAPPED_URL_PATH", "/universtiesstudiess/")
WRAPPED_QUERY_PARAM = os.environ.get("WRAPPED_QUERY_PARAM", "insurancessstudiess")
WHITELISTED_DOMAINS = os.environ.get("WHITELISTED_DOMAINS", "arolinks.com,vshort.in,gplinks.in,darkguruji.com").split(",")
